...
function loadReviewsFromLocal() {
    ...
    if (stored) {
        ...
        // Default reviews
        reviews = [
            { id: Date.now() + 1, name: "Thabo fefe", rating: 5, text: "Fixed my water-damaged iPhone in 2 hours! Amazing service!", date: new Date().toLocaleDateString() },
            { id: Date.now() + 2, name: "Lerato Ofentse", rating: 4, text: "SSD upgrade made my laptop fly. Very professional.", date: new Date().toLocaleDateString() },
